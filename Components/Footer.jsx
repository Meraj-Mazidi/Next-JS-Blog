...
const Footer = () => {
  return (
    <div className="text-center mt-20 mb-8 p-12 relative rounded-lg bg-black bg-opacity-20">
      ...
      <h3 className="text-white my-4 text-xl font-bold">Meraj Mazidi</h3>
      <p className="text-white text-lg">
        This is a blog project, created using React, Next JS, Graph QL, Graph
        CMS, Tailwind CSS and more. Nextjs is Awesome!
      </p>
      <a
      ...
      <p className="text-white text-lg">merajmazidiwork@gmail.com</p>
    </div>
  );
};
